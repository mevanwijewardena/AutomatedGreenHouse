...
int main(void)
{
	...
	Lcd4_Set_Cursor(1,1);
	Lcd4_Write_String("A:Water plants");
	Lcd4_Set_Cursor(2,1);
	Lcd4_Write_String("*:Fertilize");
    ...
    while(1){
		...
		if(processor_state==0){
		  ...
		  while(1){
			...
			while(1){
			...
			else if(processor_state==11){
				Lcd4_Clear();
				Lcd4_Set_Cursor(1,1);
				Lcd4_Write_String("Specify time");
				int m1=rowdet();
				int temp=0;
				int pos=0;
				while(pos<2){
					if(m1){
						...
						processor_state=11;
						pos++;
						if(pos!=2 && keypressed==0x77){
							Lcd4_Write_Char('1');
							temp=(10*temp)+1;
						}
						else if(pos!=2 && keypressed==0x7B){
							Lcd4_Write_Char('2');
							temp=(10*temp)+2;
						}
						else if(pos!=2 && keypressed==0x7D){
							Lcd4_Write_Char('3');
							temp=(10*temp)+3;
						}
						else if(pos!=2 && keypressed==0xB7){
							Lcd4_Write_Char('4');
							temp=(10*temp)+4;
						}
						else if(pos!=2 && keypressed==0xBB){
							Lcd4_Write_Char('5');
							temp=(10*temp)+5;
						}
						else if(pos!=2 && keypressed==0xBD){
							Lcd4_Write_Char('6');
							temp=(10*temp)+6;
						}
						else if(pos!=2 && keypressed==0xD7){
							Lcd4_Write_Char('7');
							temp=(10*temp)+7;
						}
						else if(pos!=2 && keypressed==0xDB){
							Lcd4_Write_Char('8');
							temp=(10*temp)+8;
						}
						else if(pos!=2 && keypressed==0xDD){
							Lcd4_Write_Char('9');
							temp=(10*temp)+9;
						}
						else if(pos!=2 && keypressed==0xEB){
							Lcd4_Write_Char('0');
							temp=(10*temp);
						}
						else if(keypressed==0xBE){
				...
				Lcd4_Clear();
				Lcd4_Set_Cursor(1,1);
				Lcd4_Write_String("Watering");
				Lcd4_Set_Cursor(2,1);
				Lcd4_Write_String("System Busy");
				DDRA|=(1<<3);
				PORTA&=~(1<<3);
				int32_t t1=3600;
				int32_t tt=t1*Humidity;
				int32_t t3=0;
				while(t3<tt){
					_delay_ms(1);
					tt++;
